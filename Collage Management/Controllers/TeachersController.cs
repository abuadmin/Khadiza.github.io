...
namespace Collage_Management.Controllers
{
    ...
    public class TeachersController : Controller
    {
        ...
        {
            var teachers = db.Teachers.Include(t => t.Designation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TeacherId,TeacherName,DesignationID,PhoneNo,Address")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
